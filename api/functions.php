...
function send_mail($mail, $message, $to, $subject){		
	$host = 'mail.agbetuntun.com';
	$username = 'support@agbetuntun.com';
	$passwd   = 'NewFarming20';
	$mailfrom = 'support@agbetuntun.com';
	$sendername = 'Agbetuntun Agribusiness';
	$img_link = 'agbetuntun.com/uploads/';
	// $img_link = '../uploads/';
      ...
      .link {
		...
		<body>
			<header class="bg-dark text-center">
				<img src="'.$img_link.'agbetuntun-logo.png" alt="Agbetuntun Logo">
			</header>
